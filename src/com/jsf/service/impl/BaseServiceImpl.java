...
import com.jsf.service.BaseService;
...
public class BaseServiceImpl<T> implements BaseService<T> {
	...
	@Autowired
	protected  JsclassMapper JsclassMapper;
	
	@Autowired
	protected  CourseMapper courseMapper;
	
	@Autowired
	protected  TieMapper tieMapper;
	
	@Autowired
	protected  HuifuMapper huifuMapper;
	
	@Autowired
	protected  OrderMapper orderMapper;

	@Autowired
	protected  AmMapper amMapper;
