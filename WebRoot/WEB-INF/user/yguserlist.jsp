			    ...
			    toolbar: [{
					...
					handler: function(){
						...
						parent.$('#win').window({    
						    ...
						    height:400,    
						    modal:true,
						    content:"<iframe src='${proPath}/base/goURL/user/yginsert.action' height='100%' width='100%' frameborder='0px' ></iframe>"  
						}); 
					}
					...
					handler: function(){
						...
						parent.$('#win').window({    
						    ...
						    height:400,    
						    modal:true,
						    content:"<iframe src='${proPath}/base/goURL/user/ygupdate.action' height='100%' width='100%' frameborder='0px' ></iframe>"  
						}); 
