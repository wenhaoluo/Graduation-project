...
<body class="easyui-layout">
	...
	<div
		...
		<div id="aa" class="easyui-accordion"
				...
				<ul style="list-style: none;padding: 0px;margin:0px;">
					...
					<li style="padding: 6px;"><a
						...
						style="text-decoration: none;display: block;font-weight:bold;">预约课程</a>
										...
										<li style="padding: 6px;"><a
						href="${proPath}/base/goURL/course/applycourse.action" 
						title="申请预约课程"
						style="text-decoration: none;display: block;font-weight:bold;">申请预约课程</a>
					</li>
			...
			<div title="营业管理">
				<ul style="list-style: none;padding: 0px;margin:0px;">
					<li style="padding: 6px;"><a
						href="${proPath}/order/insertvip.action"
						title="营业管理"
	...
	<div data-options="region:'center'"
		...
		<div id="tt" class="easyui-tabs" data-options="fit:true,"
			...
			<div title="系统介绍" style="padding:20px;"></div>
